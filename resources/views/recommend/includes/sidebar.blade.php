    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile">
            <div class="user-pro-body">
                <div><img src="/storage/profile/{{ auth()->user()->image }}" alt="user-img" class="img-circle"></div>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu animated flipInY">
                        <!-- text-->
                        <a href="{{ route('show.user',auth()->user()) }}" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                        <!-- text-->
                        <!-- text-->
                        <!-- text-->
                        <div class="dropdown-divider"></div>
                        <!-- text-->
                        <a href="{{ route('show.user',auth()->user()) }}" class="dropdown-item"><i class="ti-settings"></i> Account Setting</a>
                        <!-- text-->
                        <div class="dropdown-divider"></div>
                        <!-- text-->
